                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-3 style-inverse">
                                    ...
                                    <div class="box-body style-inverse">
                                        ...
                                        <address class="text-white">
                                            <abbr title="문의(전화)"><i class="fa fa-phone fa-fw"></i></abbr> {{ $currentStudentIsEmployeeOf->contact_number_1 }}
                                             @if($currentStudentIsEmployeeOf->contact_number_2 != "")
                                                / {{ $currentStudentIsEmployeeOf->contact_number_2 }}<br>
                                             @else
                                                <br>
                                             @endif
                                            <abbr title="문의(이메일)"><i class="fa fa-at fa-fw"></i></abbr> {{ $currentStudentIsEmployeeOf->contact_email }}
                                        </address>
                                    </div>
                                </div><!--end .col-sm-3 -->
                                <!-- END PROFILE SIDEBAR -->
